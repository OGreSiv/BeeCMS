...
class Dropdown extends Widget
{
    ...
    public function init()
    {
        if ($this->submenuOptions === null) {
            ...
            $this->submenuOptions['id'] = $this->id;
        }
        parent::init();
        Html::addCssClass($this->options, ['widget' => 'sub-menu secondary list-style-circle collapse']);
    }
    ...
    protected function renderItems($items, $options = [])
    {
        ...
        foreach ($items as $id => $item) {
            ...
            if (empty($item['items'])) {
                ...
                $submenuOptions['class'] = 'sub-menu collapse tertiary list-style-dashed';
                $subUrl = '#'.$this->submenuOptions['id'].'-'.$id;
                $submenuOptions['id'] = $this->submenuOptions['id'].'-'.$id;

                $content = Html::a($label, $url === null ? $subUrl : $url, $linkOptions)
                    . $this->renderItems($item['items'], $submenuOptions);
                Html::addCssClass($itemOptions, ['widget' => 'has-submenu']);
            }
