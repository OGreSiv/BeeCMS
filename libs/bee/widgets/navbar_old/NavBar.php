 ...
 *
 * Add option "showToggleButton" for show/hide ToggleButton
 * By default = True
 */
...
class NavBar extends Widget
{
    ...
    public function init()
    {
        ...
        if ($this->brandLabel !== false) {
            ...
            echo Html::a($this->brandLabel, $this->brandUrl === false ? Bee::$app->homeUrl : $this->brandUrl, $this->brandOptions);
        }
    ...
    {
        if ($this->options['showToggleButton'] === NULL || $this->options['showToggleButton'] === true) {
